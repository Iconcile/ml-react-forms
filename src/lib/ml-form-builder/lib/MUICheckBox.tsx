                        ...
                        (
                            map(menuOptions, (item: MenuOptionObject, index) => (
                                <FormControlLabel
                                    ...
                                    control={<Checkbox checked={(indexOf(value, item.value) > -1)} onBlur={formikProps.handleBlur} onChange={formikProps.handleChange} value={item.value}  {...{ ...checkboxProps, id: `${fieldConfig.id}_check_${index}` }} data-testid={(fieldProps as any)['data-testid'] ? `${(fieldProps as any)['data-testid']}-${index}` : `checkbox-${fieldProps.name}-${index}`} />}
                                    label={item.name || ''}
                            ...
                            <FormControlLabel
                                control={<Checkbox checked={(value || false)} onBlur={formikProps.handleBlur} onChange={formikProps.handleChange}  {...checkboxProps} data-testid={(fieldProps as any)['data-testid'] || `checkbox-${fieldProps.name}`} />}
