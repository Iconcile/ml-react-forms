    ...
    return (React.createElement(FieldArray, { name: fieldProps.name, render: function (arrayHelpers) { return (React.createElement("div", null,
            (values || []).map(function (value, index) { return (React.createElement(Box, { key: "".concat(fieldProps.name, "-").concat(index), position: 'relative', "data-testid": fieldProps['data-testid'] ? "".concat(fieldProps['data-testid'], "-item-").concat(index) : "field-array-item-".concat(fieldProps.name, "-").concat(index) },
                ...
                (removeButton) ? removeButton : (React.createElement(IconButton, __assign({ sx: {
                    ...
                    }, size: "small", onClick: function () { return handleRemove(arrayHelpers, index); }, "data-testid": fieldProps['data-testid'] ? "".concat(fieldProps['data-testid'], "-remove-").concat(index) : "field-array-remove-".concat(fieldProps.name, "-").concat(index) }, removeButtonProps),
                    React.createElement(CloseIcon, null))))); }),
            React.createElement("div", null, (addButton) ? addButton : (React.createElement(Button, __assign({ type: "button", onClick: function () { return arrayHelpers.push(defaultData); }, "data-testid": fieldProps['data-testid'] || "field-array-add-".concat(fieldProps.name) }, addButtonProps), addButtonText))))); } }));
}, function (p, n) {
    var _a, _b, _c, _d;
    p.fieldProps.id = '1';
    n.fieldProps.id = '1';
