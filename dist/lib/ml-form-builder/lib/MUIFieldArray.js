...
export var MUIFieldArray = memo(function (props) {
    ...
    var itemType = fieldProps.itemType, _c = fieldProps.addButtonText, addButtonText = _c === void 0 ? 'Add' : _c, addButtonProps = fieldProps.addButtonProps, addButton = fieldProps.addButton, removeButton = fieldProps.removeButton, removeButtonProps = fieldProps.removeButtonProps, _d = fieldProps.textFieldProps, textFieldProps = _d === void 0 ? {} : _d, _e = fieldProps.defaultData, defaultData = _e === void 0 ? {} : _e, onRemove = fieldProps.onRemove, _f = fieldProps.verticalSpacing, verticalSpacing = _f === void 0 ? 10 : _f, _g = fieldProps.virtualized, virtualized = _g === void 0 ? false : _g, _h = fieldProps.virtualizedHeight, virtualizedHeight = _h === void 0 ? 720 : _h, _j = fieldProps.virtualizedWidth, virtualizedWidth = _j === void 0 ? '100%' : _j, _k = fieldProps.virtualizedItemHeight, virtualizedItemHeight = _k === void 0 ? 88 : _k, virtualizedItemKey = fieldProps.virtualizedItemKey, _l = fieldProps.virtualizedAlwaysShowScrollbar, virtualizedAlwaysShowScrollbar = _l === void 0 ? false : _l, virtualizedContainerStyle = fieldProps.virtualizedContainerStyle, itemContainerStyle = fieldProps.itemContainerStyle;
    ...
    var renderItem = function (value, index, arrayHelpers, style) { return (React.createElement(Box, { key: getItemKey(value), style: style, "data-testid": fieldProps['data-testid'] ? "".concat(fieldProps['data-testid'], "-item-").concat(index) : "field-array-item-".concat(fieldProps.name, "-").concat(index) },
        React.createElement(Box, { position: 'relative', minHeight: virtualized ? virtualizedItemHeight : undefined, paddingRight: removeButton ? undefined : 5, style: __assign({ display: 'flex', marginBottom: verticalSpacing }, itemContainerStyle) },
