...
export var MUIRadio = function (props) {
    ...
    return (React.createElement(FormControl, __assign({ error: !!fieldError }, formControlProps),
        ...
        React.createElement(RadioGroup, __assign({ name: fieldProps.name, value: fieldValue, onChange: formikProps.handleChange, onBlur: formikProps.handleBlur }, radioGroupProps, { "data-testid": fieldProps['data-testid'] ? "".concat(fieldProps['data-testid'], "-group") : "radio-group-".concat(fieldProps.name) }), map(menuOptions, function (option, index) {
