...
export var MUIDropDownTimePicker = function (props) {
    ...
    return (React.createElement(FormControl, __assign({}, formControlProps),
        ...
        React.createElement(Select, __assign({ labelId: labelId, id: fieldConfig.id, value: value, onChange: onChange, error: error }, selectProps, { "data-testid": ddtpTestId || "timepicker-dropdown-".concat(fieldProps.name) }),
            (emptyItem) &&
