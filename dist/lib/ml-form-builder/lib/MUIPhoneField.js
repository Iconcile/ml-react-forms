        ...
        React.createElement(Box, { width: "100%", display: "flex", alignItems: "flex-end" },
            React.createElement(Box, __assign({ width: "30%" }, countryCodeContainerProps),
                React.createElement(FormControl, __assign({ fullWidth: true }, countryCodeFormControlProps, { error: error }),
                    ...
                    React.createElement(Select, __assign({ labelId: fieldProps.name, value: code, onChange: codeChange, "data-testid": fieldProps['data-testid'] ? "".concat(fieldProps['data-testid'], "-country") : "phone-country-".concat(fieldProps.name) }, countryCodeProps, { native: true }),
                        (emptyItem) &&
            ...
            React.createElement(Box, __assign({ width: "70%", marginLeft: "5px" }, phoneContainerProps),
                React.createElement(TextField, __assign({ fullWidth: true, label: phoneLabel || "Phone", InputProps: {
                    ...
                    }, onBlur: handleBlur, autoComplete: "nope", type: "tel", value: value.split("-")[1] || "", error: error, onChange: onChange, "data-testid": fieldProps['data-testid'] ? "".concat(fieldProps['data-testid'], "-number") : "phone-number-".concat(fieldProps.name) }, phoneNumberProps)))),
