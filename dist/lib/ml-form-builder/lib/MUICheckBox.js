...
export var MUICheckBox = function (props) {
    ...
    return (React.createElement(FormControl, __assign({ error: !!fieldError }, formControlProps),
        ...
        React.createElement(FormGroup, __assign({}, checkGroupProps), (!isEmpty(menuOptions)) ?
            (map(menuOptions, function (item, index) { return (React.createElement(FormControlLabel, __assign({ key: "".concat(fieldConfig.id, "_check_").concat(index), control: React.createElement(Checkbox, __assign({ checked: (indexOf(value, item.value) > -1), onBlur: formikProps.handleBlur, onChange: formikProps.handleChange, value: item.value }, __assign(__assign({}, checkboxProps), { id: "".concat(fieldConfig.id, "_check_").concat(index) }), { "data-testid": fieldProps['data-testid'] ? "".concat(fieldProps['data-testid'], "-").concat(index) : "checkbox-".concat(fieldProps.name, "-").concat(index) })), label: item.name || '' }, formControlLabelProps))); })) : (React.createElement(FormControlLabel, __assign({ control: React.createElement(Checkbox, __assign({ checked: (value || false), onBlur: formikProps.handleBlur, onChange: formikProps.handleChange }, checkboxProps, { "data-testid": fieldProps['data-testid'] || "checkbox-".concat(fieldProps.name) })), label: isLabelHtmlString ? React.createElement("div", { dangerouslySetInnerHTML: { __html: label } }) : label }, formControlLabelProps)))),
