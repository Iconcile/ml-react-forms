...
export var BuildFormRow = function (props) {
    ...
    var rowStyle = { marginBottom: (rowSettings.verticalSpacing !== null && rowSettings.verticalSpacing !== void 0 ? rowSettings.verticalSpacing : 10), display: 'flex' };
...
export var MLFormAction = function (props) {
    ...
    var ActionContainer = styled('div')(function () {
        return (__assign(__assign(__assign({ position: 'relative', display: 'flex', justifyContent: 'center' }, (submitButtonLayout === 'center' && {
